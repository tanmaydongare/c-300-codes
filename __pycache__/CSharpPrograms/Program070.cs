// Question: Program to compare strings
...
public class Program070
{
    public static async Task Main()
    {
        ...
        Console.WriteLine($"Ordinal equals: {string.Equals(a, b, StringComparison.Ordinal)}");
        Console.WriteLine($"IgnoreCase equals: {string.Equals(a, b, StringComparison.OrdinalIgnoreCase)}");
        Console.WriteLine($"CompareTo: {string.Compare(a, b, StringComparison.Ordinal)}");
    }
