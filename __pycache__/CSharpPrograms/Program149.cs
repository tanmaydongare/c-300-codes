// Question: Program to demonstrate attributes
...
public class Program149
{
    ...
    {
        var attrs = typeof(AttrDemo).GetCustomAttributes(false);
        Console.WriteLine($"AttrDemo attribute count: {attrs.Length}");

        [Obsolete("Demo attribute")]
        class AttrDemo { }
    }
