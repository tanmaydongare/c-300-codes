// Question: (No question provided for Program 287 in the PDF.)
...
public class Program287
{
    ...
    {
        var question = @"(No question provided for Program 287 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 287");
