// Question: (No question provided for Program 272 in the PDF.)
...
public class Program272
{
    ...
    {
        var question = @"(No question provided for Program 272 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 272");
