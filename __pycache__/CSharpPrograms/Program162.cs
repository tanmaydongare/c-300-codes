// Question: Configuration management using appsettings.json
...
public class Program162
{
    ...
    {
        Console.WriteLine("Configuration demo using appsettings.json-like file");
        var path = "appsettings.json";
        if (!System.IO.File.Exists(path))
        {
            var defaultJson = System.Text.Json.JsonSerializer.Serialize(new { AppName = "Demo", MaxItems = 10 }, new System.Text.Json.JsonSerializerOptions { WriteIndented = true });
        ...
        var maxItems = doc.RootElement.GetProperty("MaxItems").GetInt32();
        Console.WriteLine($"AppName={appName}, MaxItems={maxItems}");
    }
