// Question: Console-based Banking System
...
public class Program153
{
    ...
    {
        Console.WriteLine("Banking System (single account demo)");
        decimal balance = 0m;
        while (true)
        {
            Console.WriteLine("1) Deposit  2) Withdraw  3) Balance  4) Exit");
            ...
            if (choice == "1")
            {
                ...
                if (decimal.TryParse(Console.ReadLine(), out var amt) && amt > 0) balance += amt;
                else Console.WriteLine("Invalid amount");
            }
            else if (choice == "2")
            {
                Console.Write("Amount: ");
                if (decimal.TryParse(Console.ReadLine(), out var amt) && amt > 0 && amt <= balance) balance -= amt;
                else Console.WriteLine("Invalid/insufficient");
            }
            else if (choice == "3") Console.WriteLine($"Balance: {balance}");
