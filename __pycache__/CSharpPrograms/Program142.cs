// Question: Program to demonstrate async and await
...
public class Program142
{
    ...
    {
        Console.WriteLine("Fetching example.com (async)...");
        var text = await FetchAsync();
        Console.WriteLine($"Downloaded {text.Length} characters");

        static async System.Threading.Tasks.Task<string> FetchAsync()
        {
