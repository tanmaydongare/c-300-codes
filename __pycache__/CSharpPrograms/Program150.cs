// Question: Program to demonstrate performance optimization basics
...
public class Program150
{
    ...
    {
        Console.WriteLine("Performance basics:");
        Console.WriteLine("- Avoid unnecessary allocations");
        Console.WriteLine("- Prefer StringBuilder for many concatenations");
        Console.WriteLine("- Measure using Stopwatch");
        var sw = System.Diagnostics.Stopwatch.StartNew();
        long sum = 0; for (int i = 0; i < 5_000_00; i++) sum += i;
        sw.Stop();
