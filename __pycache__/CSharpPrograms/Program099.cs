// Question: Program to demonstrate immutability of strings
...
public class Program099
{
    public static async Task Main()
    {
        ...
        var t = s;
        s += " world";
        Console.WriteLine($"Original t: {t}");
        Console.WriteLine($"New s: {s}");
        Console.WriteLine("Strings are immutable; concatenation creates a new string.");
    }
