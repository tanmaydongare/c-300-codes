// Question: (No question provided for Program 297 in the PDF.)
...
public class Program297
{
    ...
    {
        var question = @"(No question provided for Program 297 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 297");
