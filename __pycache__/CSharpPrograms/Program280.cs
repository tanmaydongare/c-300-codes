// Question: (No question provided for Program 280 in the PDF.)
...
public class Program280
{
    ...
    {
        var question = @"(No question provided for Program 280 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 280");
