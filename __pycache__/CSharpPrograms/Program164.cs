// Question: Unit Testing using xUnit
...
public class Program164
{
    ...
    {
        Console.WriteLine("Unit testing/mocking typically lives in a separate test project.");
        Console.WriteLine("This console demo prints what you would test and why.");
        Console.WriteLine("Example: Given Add(2,3) expect 5; Given invalid input expect exception.");
    }
