// Question: Program to demonstrate Math class
...
public class Program049
{
    public static async Task Main()
    {
        ...
        Console.WriteLine($"Abs={Math.Abs(value)}, Sqrt={Math.Sqrt(Math.Abs(value))}, Pow2={Math.Pow(value, 2)}");
        Console.WriteLine($"Min(10,n)={Math.Min(10, value)}, Max(10,n)={Math.Max(10, value)}");
    }
