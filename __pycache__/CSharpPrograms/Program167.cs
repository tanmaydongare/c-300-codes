// Question: API Consumption using HttpClient
...
public class Program167
{
    ...
    {
        Console.WriteLine("HTTP GET using HttpClient");
        using var http = new System.Net.Http.HttpClient();
        http.DefaultRequestHeaders.UserAgent.ParseAdd("CSharpPrograms/1.0");
        var url = "https://example.com";
        var text = await http.GetStringAsync(url);
        Console.WriteLine($"Fetched {text.Length} characters from {url}");
    }
