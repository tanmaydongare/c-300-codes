// Question: (No question provided for Program 273 in the PDF.)
...
public class Program273
{
    ...
    {
        var question = @"(No question provided for Program 273 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 273");
