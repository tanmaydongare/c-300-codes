// Question: Program to find common elements in two arrays
...
public class Program094
{
    public static async Task Main()
    {
        ...
        var b = ReadIntArray();
        var setA = new System.Collections.Generic.HashSet<int>(a);
        setA.IntersectWith(b);
        Console.WriteLine("Common elements: " + string.Join(" ", setA));
    }
