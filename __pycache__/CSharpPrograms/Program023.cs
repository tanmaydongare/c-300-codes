// Question: Program to calculate area of circle
...
public class Program023
{
    public static async Task Main()
    {
        ...
        if (!double.TryParse(Console.ReadLine(), out var r) || r < 0) { Console.WriteLine("Invalid input"); return; }
        Console.WriteLine($"Area = {Math.PI * r * r:F4}");
    }
