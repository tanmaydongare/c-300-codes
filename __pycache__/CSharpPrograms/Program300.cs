// Question: (No question provided for Program 300 in the PDF.)
...
public class Program300
{
    ...
    {
        var question = @"(No question provided for Program 300 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 300");
