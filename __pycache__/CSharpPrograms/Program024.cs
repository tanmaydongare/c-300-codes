// Question: Program to calculate area of rectangle
...
public class Program024
{
    public static async Task Main()
    {
        ...
        if (!double.TryParse(Console.ReadLine(), out var l) || l < 0) { Console.WriteLine("Invalid input"); return; }
        Console.Write("Enter width: ");
        if (!double.TryParse(Console.ReadLine(), out var w) || w < 0) { Console.WriteLine("Invalid input"); return; }
        Console.WriteLine($"Area = {l * w:F4}");
    }
