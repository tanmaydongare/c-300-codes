// Question: Program to demonstrate nullable types
...
public class Program043
{
    public static async Task Main()
    {
        ...
        Console.WriteLine($"Nullable has value? {maybeNumber.HasValue}");
        maybeNumber = 10;
        Console.WriteLine($"Nullable value: {maybeNumber}");
        Console.WriteLine($"Null-coalescing: {maybeNumber ?? 0}");
    }
