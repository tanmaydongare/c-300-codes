// Question: Program to find power of a number
...
public class Program037
{
    public static async Task Main()
    {
        ...
        if (!double.TryParse(Console.ReadLine(), out var e)) { Console.WriteLine("Invalid input"); return; }
        Console.WriteLine($"Power = {Math.Pow(b, e)}");
    }
