// Question: Program to calculate factorial using recursion
...
public class Program075
{
    ...
    {
        long Fact(int n) => n < 2 ? 1 : n * Fact(n - 1);
        ...
        if (value < 0) { Console.WriteLine("Invalid"); return; }
        Console.WriteLine($"Factorial = {Fact(value)}");
    }
