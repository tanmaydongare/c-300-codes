// Question: (No question provided for Program 290 in the PDF.)
...
public class Program290
{
    ...
    {
        var question = @"(No question provided for Program 290 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 290");
