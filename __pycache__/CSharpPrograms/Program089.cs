// Question: Program to demonstrate regular expressions
...
public class Program089
{
    public static async Task Main()
    {
        ...
        Console.WriteLine($"Found {matches.Count} number(s):");
        foreach (System.Text.RegularExpressions.Match m in matches) Console.WriteLine(m.Value);
    }
