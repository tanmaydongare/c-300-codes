// Question: Program to demonstrate memory management basics
...
public class Program100
{
    ...
    {
        Console.WriteLine("Memory management basics in .NET:");
        Console.WriteLine("- Managed heap allocations are tracked by the GC");
        Console.WriteLine("- Unused objects are collected automatically");
        Console.WriteLine("- Use IDisposable/using for unmanaged resources");
