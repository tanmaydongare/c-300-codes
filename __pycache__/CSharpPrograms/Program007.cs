// Question: Program to calculate simple interest
...
public class Program007
{
    public static async Task Main()
    {
        ...
        if (!decimal.TryParse(Console.ReadLine(), out var p)) { Console.WriteLine("Invalid input"); return; }
        Console.Write("Enter rate (% per annum): ");
        if (!decimal.TryParse(Console.ReadLine(), out var r)) { Console.WriteLine("Invalid input"); return; }
        Console.Write("Enter time (years): ");
        if (!decimal.TryParse(Console.ReadLine(), out var t)) { Console.WriteLine("Invalid input"); return; }
        var si = (p * r * t) / 100m;
