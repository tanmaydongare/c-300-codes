// Question: Program to find duplicate elements in array
...
public class Program096
{
    public static async Task Main()
    {
        ...
        var dup = new System.Collections.Generic.HashSet<int>();
        foreach (var v in arr) { if (!seen.Add(v)) dup.Add(v); }
        Console.WriteLine("Duplicates: " + (dup.Count == 0 ? "(none)" : string.Join(" ", dup)));
    }
