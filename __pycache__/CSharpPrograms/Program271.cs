// Question: (No question provided for Program 271 in the PDF.)
...
public class Program271
{
    ...
    {
        var question = @"(No question provided for Program 271 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 271");
