// Question: Program to replace substring in string
...
public class Program068
{
    public static async Task Main()
    {
        ...
        var oldSub = Console.ReadLine() ?? string.Empty;
        Console.Write("Enter replacement: ");
        var newSub = Console.ReadLine() ?? string.Empty;
        Console.WriteLine(s.Replace(oldSub, newSub));
    }
