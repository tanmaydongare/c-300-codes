// Question: (No question provided for Program 201 in the PDF.)
...
public class Program201
{
    ...
    {
        var question = @"(No question provided for Program 201 in the PDF.)";
        Console.WriteLine("This program is a placeholder.");
        Console.WriteLine("Program number: 201");
