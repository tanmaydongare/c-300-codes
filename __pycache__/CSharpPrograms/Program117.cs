// Question: Program to demonstrate abstract class vs interface
...
public class Program117
{
    public static async Task Main()
    {
        ...
        Console.WriteLine("- abstract class can have state and implementation");
        Console.WriteLine("- interface defines a contract; types can implement multiple interfaces");
    }
