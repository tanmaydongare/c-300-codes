// Question: Program to remove duplicate elements from array
...
public class Program057
{
    public static async Task Main()
    {
        ...
        var set = new System.Collections.Generic.HashSet<int>(arr);
        Console.WriteLine("Without duplicates: " + string.Join(" ", set));
    }
