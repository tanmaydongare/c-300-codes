// Question: Program to demonstrate reflection
...
public class Program148
{
    public static async Task Main()
    {
        ...
        Console.WriteLine("Methods containing 'Substring':");
        foreach (var m in t.GetMethods().Where(m => m.Name.Contains("Substring")).Take(5))
            Console.WriteLine(m);
    }
