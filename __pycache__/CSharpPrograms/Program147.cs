// Question: Program to demonstrate serialization (JSON)
...
public class Program147
{
    public static async Task Main()
    {
        ...
        var back = System.Text.Json.JsonSerializer.Deserialize<System.Collections.Generic.Dictionary<string, System.Text.Json.JsonElement>>(json);
        Console.WriteLine(back is null ? "Deserialize failed" : "Deserialized keys: " + string.Join(",", back.Keys));
    }
