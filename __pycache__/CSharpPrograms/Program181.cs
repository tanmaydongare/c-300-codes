// Question: Microservices Communication (Basic)
...
public class Program181
{
    ...
    {
        Console.WriteLine("Microservices communication (basic): calling another service via HTTP");
        Console.WriteLine("Try running Program167 (HttpClient) against a local endpoint.");
    }
