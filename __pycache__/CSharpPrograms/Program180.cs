// Question: Real-time Communication using SignalR
...
public class Program180
{
    ...
    {
        Console.WriteLine("Real-time communication typically uses SignalR/WebSockets.");
        Console.WriteLine("Console demo: a simple pub-sub event bus.");
        var bus = new Bus();
        bus.Message += (_, m) => Console.WriteLine("Subscriber got: " + m);
        bus.Publish("hello");
    }
